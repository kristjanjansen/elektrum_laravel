...
class CreateSarpSubcontractorAreasTable extends Migration {
	...
	public function up()
	{
		Schema::create('sarp_subcontractor_areas', function(Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::drop('sarp_subcontractor_areas');
	}
